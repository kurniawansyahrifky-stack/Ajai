...
dispatcher = memeg.kntl  # ganti ini kalau mau pake Telethon client (kalau mau pake python-telegram-bot, buat wrapper)
OWNER_ID = memeg.OWNER_IDS[0]  # ambil primary owner
LOGGER = memeg.LOGGER
...
WELC_HELP_TXT = "Your group's welcome/goodbye messages can be personalised in multiple ways. If you want the messages" \
                ...
                "remove it.\n" \
                "If you're feeling fun, you can even set images/gifs/videos/voice

messages as the welcome message by replying to the desired media, and calling /setwelcome.".format(dispatcher.bot.username)
